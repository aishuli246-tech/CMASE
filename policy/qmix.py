...
class QMIX:
    def __init__(self, args):
        ...
        if self.args.load_model:
            print(self.model_dir + '/rnn_net_params.pkl')
    ...
    def learn(self, batch, max_episode_len, train_step, epsilon=None):  # train_step表示是第几次学习，用来控制更新target_net网络的参数
        ...
        obs, obs_next, s, s_next, u, r, avail_u, avail_u_next, terminated = batch['o'], batch['o_next'], batch['s'], batch['s_next'], batch['u'], \
        ...
        q_total_eval = self.eval_qmix_net(obs, avail_u, s, q_evals)
        q_total_target = self.target_qmix_net(obs_next, avail_u_next, s_next, q_targets)
    ...
    def save_model(self, train_step):
        ...
        torch.save(self.eval_qmix_net.state_dict(), self.model_dir + '/qmix_net_params.pkl')
