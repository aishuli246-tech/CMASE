...
def get_common_args():
    ...
    parser.add_argument('--model_dir', type=str, default='./model of NSE', help='model directory of the policy')
    parser.add_argument('--result_dir', type=str, default='./result of NSE', help='result directory of the policy')
